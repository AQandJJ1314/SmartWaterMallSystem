...
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (5, 1, 'admin', '13612345678', 1, 3, NULL, NULL, '2024-12-13 15:40:05', '2024-12-13 15:53:03');
...
-- ----------------------------
INSERT INTO `wms_purchase_detail` VALUES (8, 5, 3, 100, NULL, 1, 3);
INSERT INTO `wms_purchase_detail` VALUES (10, 5, 4, 100, NULL, 1, 3);
INSERT INTO `wms_purchase_detail` VALUES (14, NULL, 3, 100, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (15, NULL, 4, 100, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (16, NULL, 4, 100, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (17, NULL, 3, 1100, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (18, NULL, 4, 11, NULL, 1, 0);
...
CREATE TABLE `wms_ware_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仓库信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_ware_info
-- ----------------------------
INSERT INTO `wms_ware_info` VALUES (1, '手机产品仓库', '上海', '1');
INSERT INTO `wms_ware_info` VALUES (2, '手机配件仓库', '上海', '2');
INSERT INTO `wms_ware_info` VALUES (3, '电脑仓库', '上海', '3');
INSERT INTO `wms_ware_info` VALUES (4, '电脑配件仓库', '上海', '4');
INSERT INTO `wms_ware_info` VALUES (5, '测试仓库', '北京', 'beijing');
INSERT INTO `wms_ware_info` VALUES (6, '测试仓库', '北京222', 'beijing222');
...
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES (1, 22, 3, 4, '笔记本1', 0);
INSERT INTO `wms_ware_sku` VALUES (2, 2, 2, 20, '小米蓝牙耳机', 0);
INSERT INTO `wms_ware_sku` VALUES (4, 4, 5, 2, '测试硬件', 0);
INSERT INTO `wms_ware_sku` VALUES (7, 3, 1, 100, 'iphone 15 ProMax 蓝色 8+256GB', 0);
INSERT INTO `wms_ware_sku` VALUES (8, 4, 1, 100, 'iphone 15 ProMax 黑色 12+256GB', 0);
